...
if(isset($_POST['submit'])){
	...
	$sql="insert into `leave`(leave_id,leave_from,leave_to,employee_id,leave_description,leave_status,noofdays) values('$leave_id','$leave_from','$leave_to','$employee_id','$leave_description',1,'$noofdays')";
                        ...
                        <div class="card-body card-block">
                           <form method="post">
							   ...
							   <div class="form-group">
									...
									<input type="date" id="dateControl" name="leave_from"  class="form-control" min="2023-02-01" required>
								</div>
								<div class="form-group">
									<label class=" form-control-label">To Date</label>
									<input type="date" id="dateControl" name="leave_to" class="form-control" min="2023-02-01" required>
								</div>
								<div class="form-group">
