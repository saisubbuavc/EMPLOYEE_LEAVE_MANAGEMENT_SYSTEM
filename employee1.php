                  ...
                  <div class="col-xl-12">
                     <div class="card">
                        <div class="card-body">
						   ...
						   <h4 class="box_title_link"><a href="add_employee1.php">Add Employee</a> </h4>
                        </div>
                        <div class="card-body--">
                              ...
                              <table class="table ">
                                 ...
                                 <tbody>
									...
									<tr>
									   ...
									   <td><a href="add_employee1.php?id=<?php echo $row['id']?>">Edit</a> <a href="employee1.php?id=<?php echo $row['id']?>&type=delete">Delete</a></td>
                                    </tr>
									<?php 
									$i++;
									} ?>
